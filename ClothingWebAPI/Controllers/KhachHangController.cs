...
namespace ClothingWebAPI.Controllers
{
    ...
    public class KhachHangController : ControllerBase
    {
        ...
        [HttpPost]
        [Route("login")]
        public ActionResult<KHACH_HANG_w_TOKEN> Login(KHACH_HANG_ENTITY khachHang)
        {
        ...
        [HttpPost]
        [Route("sign-up")]
        public ActionResult<KHACH_HANG_w_TOKEN> SignUp(KHACH_HANG_ENTITY khachHang)
        {
            var khachHangReturnFromSP = new KHACH_HANG_ENTITY();
            //using (var con = new SqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["DefaultConnection"].ConnectionString))
            using (var con = new SqlConnection(_configuration.GetConnectionString("CLOTHING_STORE_CONN")))
        ...
        public ActionResult<KHACH_HANG_w_TOKEN> ValidateSignUp(KHACH_HANG_ENTITY khachHang)
        {
            var khachHangReturnFromSP = new KHACH_HANG_ENTITY();
            //using (var con = new SqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["DefaultConnection"].ConnectionString))
            using (var con = new SqlConnection(_configuration.GetConnectionString("CLOTHING_STORE_CONN")))
        ...
        [HttpPost]
        [Route("add-cart")]
        public ActionResult<string> TaoGioHang(GIO_HANG_ENTITY gioHang)
        {
            var returnstr = "";
            var idGioHang = -1;
            //using (var con = new SqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["DefaultConnection"].ConnectionString))
        ...
        [HttpGet]
        [Route("carts")]
        public IList<GIO_HANG_ENTITY> GetAllGioHang([FromQuery(Name = "filterState")] int filterState, [FromQuery(Name = "customerId")] string customerId)
        {
        ...
        [HttpPut]
        [Route("cancel-cart")]
        public ActionResult<RESPONSE_ENTITY> CancelCart(DUYET_GIAO_GH_ENTITY duyetGiao)
        {
