...
namespace ClothingWebAPI.Controllers
{
    ...
    public class ThayDoiGiaController : ControllerBase
    {
        ...
        [HttpGet]
        [Route("all")]
        public async Task<IList<THAY_DOI_GIA_ENTITY>> GetAllThayDoiGia([FromQuery(Name = "filterState")] int filterState)
        {
        ...
        //[HttpGet]
        //[Route("")]
        //public THAY_DOI_GIA_ENTITY GetOneThayDoiGia([FromQuery(Name = "MA_NV")] string priceChangeId)
        //{
        ...
        //            cmd.Parameters.Add("@MA_PT", SqlDbType.VarChar).Value = priceChangeId;
